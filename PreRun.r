...
# Function To Integrate Geographic Covariates With Either District or Tehsil Level Data
...
# Function for Taking the Mean Disregarding 0

nz_mean <- function(x){
  mean(x[x!=0])
}

#Read in Past Extract of Tehsils Level Data With Covariates and Vaccination Data Included

# tehsils <- read.csv("TehsilDataOutput.csv")
